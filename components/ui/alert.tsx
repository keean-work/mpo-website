...
// Rendered as <p> (not a heading) so an alert's title never participates in the
// document heading outline — avoids heading-level skips (accessibility, spec §13).
// The alert's role="alert" already announces the content to assistive tech.
